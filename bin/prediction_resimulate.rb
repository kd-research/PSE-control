...
alt::LoadPredictions.load_reference
...
bench_types.each do |bench_type|
  ...
  report_hash[bench_type + "_trth"] = alt::BenchAnalyzer.report_difference_for('budget-ground', 'truthy', bench_type)
  report_hash[bench_type + "_rndm"] = alt::BenchAnalyzer.report_difference_for('budget-ground', 'random', bench_type)
end
