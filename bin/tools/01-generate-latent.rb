...
def prepare_snapshot(result_path)
  ...
  Snapshot.recover_snapshot_from(result_path)
  ...
  ParameterDatabase.establish_connection(target: :sqlite3, database: metadata_path)
end

prepare_snapshot(args.af_result_path)

def extract_latents(agent_num: 10)
